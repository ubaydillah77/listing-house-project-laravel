                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.amenity.update', $amenity->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="icon">Select Icon <span class="text-danger">*</span></label> <br>
                                    <button class="btn btn-primary" role="iconpicker" data-align="left"
                                        data-unselected-class="btn-primary" name="icon"
                                        data-icon="{{ $amenity->icon }}"></button>
                                </div>
                                <div class="form-group">
